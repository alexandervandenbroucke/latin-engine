...
data Declension = I | II | III | IV | V deriving (Eq,Ord,Show)

data Case = NOM | ACC | GEN | DAT | ABL | VOC deriving (Eq,Ord,Show)

data Multiplicity = S | P deriving (Eq,Ord,Show)

data Gender = M | F | N deriving (Eq,Ord,Show)
